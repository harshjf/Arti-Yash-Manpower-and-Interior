            ...
            <div className="col-lg-4 col-md-6 col-sm-12">
              <div className="footer-col">
                ...
                <p style={{ paddingTop: "20px" }}>
                  We deliver quality solutions with precision, reliability, and
                  innovation, ensuring lasting results and continuous
                  improvement.
                </p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-12">
              <div className="footer-col">
                ...
                <ul style={{ color: "#b7b7b7" }}>
                  <li>
                    <Link href="/" style={{ color: "#b7b7b7" }}>
                      Home
                    </Link>
                  </li>
                  <li>
                    <Link href="/about-us" style={{ color: "#b7b7b7" }}>
                      About
                    </Link>
                  </li>
                  <li>
                    <Link href="/services" style={{ color: "#b7b7b7" }}>
                      Services
                    </Link>
                  </li>
                  <li>
                    <Link href="/contact" style={{ color: "#b7b7b7" }}>
                      Contact
                    </Link>
                  </li>
                </ul>
